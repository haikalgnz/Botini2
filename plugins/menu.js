...
`.trim()
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), watermark, 'Pemilik Bot', '.owner', 'Donasi', '.donasi', m, { contextInfo:{externalAdReply: {title: 'Ikal', sourceUrl: sumberurl, body: deskripsiurl, thumbnail: gambar}}})
  } catch (e) {
